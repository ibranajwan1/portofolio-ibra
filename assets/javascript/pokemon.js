class Pokemon {
    ...
    showPokemonAngin() {
        ...
        pokemon_result.style.color = "green";
    }
...
pokemon_air.addEventListener("click", () => {
    pokemon.showPokemonAir();
});

const pokemon_api = document.getElementById("pokemon2");
pokemon_api.addEventListener("click", () => {
    pokemon.showPokemonApi();
});

const pokemon_angin = document.getElementById("pokemon3");
pokemon_angin.addEventListener("click", () => {
    pokemon.showPokemonAngin();
});

const pokemon_jahat = document.getElementById("pokemon4");
pokemon_jahat.addEventListener("click", () => {
    pokemon.showPokemonJahat();
});
